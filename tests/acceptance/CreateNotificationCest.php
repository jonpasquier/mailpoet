...
class CreateNotificationCest {
  function createNotification(\AcceptanceTester $I) {
    $I->wantTo('Create a post notification email');
    $newsletter_title = 'Create Notification Test ' . \MailPoet\Util\Security::generateRandomString();
    $I->login();
